			...
			<div class="flex flex-wrap justify-center">
				<div class="w-full max-w-sm">
					<div
						...
						<div
							class="font-semibold bg-gray-200 text-gray-700 py-3 px-6 mb-0">管理員註冊</div>
						<form class="w-full p-6" method="POST"
							...
							<div class="flex flex-wrap mb-6">
								...
								</label> <input class="form-input w-full"type="email" name="adm_account" size="45"
			 value="<%= (admVO==null)? "youngsxz8929@gmail.com" : admVO.getAdm_account()%>" />
							...
							<div class="flex flex-wrap mb-6">
								<label for="address"
									...
									管理員姓名: </label> <input class="form-input w-full"type="TEXT" name="adm_name" size="45" 
			 value="<%= (admVO==null)? "吳先生" : admVO.getAdm_name()%>" />

							</div>


									<div class="flex flex-wrap">
										<button type="hidden" name="action" value="add_adm"
										...
										<p class="w-full text-xs text-center text-gray-700 mt-8 -mb-4">
											已經有帳號了? <a
												...
												href="<%=request.getContextPath()%>/back_end/adm/adm_login.jsp">
												點我登入 </a>
										</p>
									</div>
						</form>
