...
public class DBGifReader4 extends HttpServlet {
	...
	private static final String GETONEPIC = "SELECT AD_PIC FROM AD WHERE AD_ID=?";
	Connection con;
...
//    res.sendError(HttpServletResponse.SC_NOT_FOUND);
				InputStream in = getServletContext().getResourceAsStream("img/newlogo.png");
...
//   System.out.println(e);
	...
	public void init() throws ServletException {
		try {
			...
			DataSource ds = (DataSource) ctx.lookup("java:comp/env/jdbc/EA102G1");
